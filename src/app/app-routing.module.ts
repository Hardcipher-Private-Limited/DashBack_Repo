...
const routes: Routes = [
  ...
  {
    path: 'wallet',
    loadChildren: () => import('./home2/wallet/wallet.module').then( m => m.WalletPageModule)
  },
  {
    path: 'paymenthistory',
    loadChildren: () => import('./payment/paymenthistory/paymenthistory.module').then( m => m.PaymenthistoryPageModule)
  },
  {
    path: 'pay1',
    loadChildren: () => import('./payment/pay1/pay1.module').then( m => m.Pay1PageModule)
  },
  {
    path: 'pay2',
    loadChildren: () => import('./payment/pay2/pay2.module').then( m => m.Pay2PageModule)
  },
  {
    path: 'fastagproviders',
    loadChildren: () => import('./fastag/fastagproviders/fastagproviders.module').then( m => m.FastagprovidersPageModule)
  },
  {
    path: 'fastagpage1',
    loadChildren: () => import('./fastag/fastagpage1/fastagpage1.module').then( m => m.Fastagpage1PageModule)
  },
  {
    path: 'fastagpage2',
    loadChildren: () => import('./fastag/fastagpage2/fastagpage2.module').then( m => m.Fastagpage2PageModule)
  },
  {
    path: 'cableproviders',
    loadChildren: () => import('./cable/cableproviders/cableproviders.module').then( m => m.CableprovidersPageModule)
  },
  {
    path: 'cablepage1',
    loadChildren: () => import('./cable/cablepage1/cablepage1.module').then( m => m.Cablepage1PageModule)
  },
  {
    path: 'cablepage2',
    loadChildren: () => import('./cable/cablepage2/cablepage2.module').then( m => m.Cablepage2PageModule)
  },
  {
    path: 'rechargeplan',
